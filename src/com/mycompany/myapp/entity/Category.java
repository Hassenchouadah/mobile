...
public class Category {
    ...
    private Hebergement games;

    public Category(int categoryId, String categoryName, String discription, Hebergement games) {
    ...
    public Hebergement getGames() {
        return games;
    }

    public void setGames(Hebergement games) {
        this.games = games;
    }
